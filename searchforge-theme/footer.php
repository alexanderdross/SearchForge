	...
	<div class="sf-footer__bottom">
		<div class="sf-container sf-footer__bottom-inner">
			...
			<ul class="sf-footer__legal">
				<li><a href="<?php echo esc_url( 'https://dross.net/imprint/?ref=searchforge' ); ?>" target="_blank" rel="noopener">Imprint</a></li>
				<li><a href="<?php echo esc_url( 'https://dross.net/privacy-policy/?ref=searchforge' ); ?>" target="_blank" rel="noopener">Privacy Policy</a></li>
				<li><a href="<?php echo esc_url( 'https://dross.net/contact/?topic=searchforge' ); ?>" target="_blank" rel="noopener">Contact</a></li>
			</ul>
			<p>Made with &hearts; by <a href="<?php echo esc_url( 'https://dross.net/?ref=searchforge' ); ?>" target="_blank" rel="noopener">Dross:Media</a></p>
		</div>
	</div>
</footer>
