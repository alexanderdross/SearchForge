	...
	<div class="sf-container sf-container--narrow sf-section--centered">
		...
		<div class="sf-grid sf-grid--2">
			<div class="sf-card sf-card--bordered sf-lifetime-card">
				...
				<a href="<?php echo esc_url( home_url( '/checkout/?tier=lifetime-pro' ) ); ?>" class="sf-btn sf-btn--primary sf-lifetime-card__btn" rel="noopener">Get Lifetime Pro</a>
			</div>
			<div class="sf-card sf-card--bordered sf-lifetime-card">
				...
				<a href="<?php echo esc_url( home_url( '/checkout/?tier=lifetime-agency' ) ); ?>" class="sf-btn sf-btn--primary sf-lifetime-card__btn" rel="noopener">Get Lifetime Agency</a>
			</div>
		</div>
	</div>
</section>
