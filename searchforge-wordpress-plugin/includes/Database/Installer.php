	...
	private function create_tables(): void {
		...
		$sql = "
			CREATE TABLE {$wpdb->prefix}sf_properties (
				...
				adobe_org_id VARCHAR(255) DEFAULT '',
				adobe_client_id VARCHAR(255) DEFAULT '',
				adobe_client_secret TEXT DEFAULT NULL,
				adobe_report_suite_id VARCHAR(255) DEFAULT '',
				adobe_enabled TINYINT(1) NOT NULL DEFAULT 0,
